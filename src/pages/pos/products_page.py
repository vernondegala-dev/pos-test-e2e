...
class ProductsPage(BasePage):
    SELECTORS = {
        ...
        "price_input": 'input[name="list_price"]',
        "cost_input": 'input[name="standard_price"]',
        "barcode_input": 'input[name="barcode"]',
        "category_select": 'select[name="categ_id"]',
        "tax_select": 'select[name="taxes_id"]',
